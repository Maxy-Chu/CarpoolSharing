...
const file_trip_proto_rawDesc = "" +
	...
	"\bduration\x18\x03 \x01(\x01R\bduration\"\xa5\x01\n" +
	"\bRideFare\x12\x0e\n" +
	...
	"\x05route\x18\x05 \x01(\v2\v.trip.RouteR\x05route\"K\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	4,  // 6: trip.RideFare.route:type_name -> trip.Route
	8,  // 7: trip.CreateTripResponse.trip:type_name -> trip.Trip
	5,  // 8: trip.Trip.selectedFare:type_name -> trip.RideFare
	4,  // 9: trip.Trip.route:type_name -> trip.Route
	9,  // 10: trip.Trip.driver:type_name -> trip.TripDriver
	...
	1,  // 13: trip.TripService.PreviewTrip:output_type -> trip.PreviewTripResponse
	7,  // 14: trip.TripService.CreateTrip:output_type -> trip.CreateTripResponse
