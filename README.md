...
In this project, I built the backend microservices system for a Carpool sharing app from the ground up—using Go, Docker, and Kubernetes.

It is a fully deployed, horizontally scalable system that’s ready for real traffic. It is a milestone for me to get familiar with distributed projects.
